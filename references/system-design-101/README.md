# System Design 101 — Reference Index

A link-only index into [ByteByteGoHq/system-design-101](https://github.com/ByteByteGoHq/system-design-101), a curated collection of ~400 visual, plain-language explainers on system design, covering everything from HTTP internals to how Netflix scales push notifications.

No content is mirrored here — the source is licensed [CC BY-NC-ND 4.0](https://creativecommons.org/licenses/by-nc-nd/4.0/) (non-commercial, no derivatives), so this index only links out to the original guides rather than copying them.

- **Source repo:** https://github.com/ByteByteGoHq/system-design-101
- **Hosted guides:** https://bytebytego.com/guides
- **Commit indexed:** `b28380a4710c5ec9638ec037d4168e288f334cb`
- **License:** CC BY-NC-ND 4.0 — verbatim sharing with attribution is fine; no modification, no commercial use.

## Why it's useful

Each guide pairs a single diagram with a short, focused write-up — good for building system-design intuition fast, prepping for design interviews, or as case-study references (Netflix, Discord, Uber, Figma, etc.) when making real architecture decisions.
...
## Full guide index (by category)

<details>
<summary><strong>API and Web Development</strong> (46 guides)</summary>
...
<details>
<summary><strong>Real World Case Studies</strong></summary>
...
<details>
<summary><strong>Database and Storage</strong></summary>
...
<details>
<summary><strong>Technical Interviews</strong></summary>
...
<details>
<summary><strong>Payment and Fintech</strong></summary>
...
<details>
<summary><strong>Software Architecture</strong></summary>
...
<details>
<summary><strong>DevTools & Productivity</strong></summary>
...
<details>
<summary><strong>DevOps and CI/CD</strong></summary>
...
<details>
<summary><strong>Computer Fundamentals</strong></summary>
...
This work is licensed under [CC BY-NC-ND 4.0](http://creativecommons.org/licenses/by-nc-nd/4.0/) by ByteByteGo. Only links are reproduced here; no guide content is copied.
