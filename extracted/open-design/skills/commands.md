Source: `.claude/commands/od-contribute.md`

Invoked as the Claude Code slash-command `/od-contribute`. This is the
command definition that kicks off the `od-contribute` skill (see
`skills/od-contribute.md` in this extraction for the full skill playbook).
